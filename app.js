import { BlackSeriesAllele, AgoutiAllele, DilutionAllele, WhiteSpottingAllele, HairLengthAllele, createGenotype, getPhenotype, getPhenotypeColors } from './geneticsModel.js';
import { generatePunnettSquare, getPunnettSquareData, createColoredGameteDisplay, AlleleColors } from './punnettCalculator.js';
// Default state
const defaultState = {
    parent1: createGenotype(BlackSeriesAllele.Black, BlackSeriesAllele.Black, AgoutiAllele.Agouti, AgoutiAllele.NonAgouti, DilutionAllele.Normal, DilutionAllele.Normal, WhiteSpottingAllele.NoSpotting, WhiteSpottingAllele.NoSpotting, HairLengthAllele.Short, HairLengthAllele.Short),
    parent2: createGenotype(BlackSeriesAllele.Brown, BlackSeriesAllele.Cinnamon, AgoutiAllele.NonAgouti, AgoutiAllele.NonAgouti, DilutionAllele.Normal, DilutionAllele.Diluted, WhiteSpottingAllele.Spotting, WhiteSpottingAllele.NoSpotting, HairLengthAllele.Short, HairLengthAllele.Long),
    savedSettings: []
};
// Current application state
let appState = Object.assign({}, defaultState);
// DOM Elements
let calculateButton;
let saveButton;
let loadButton;
let punnettContainer;
let offspringStatsContainer;
let savedSettingsList;
let parent1Preview;
let parent2Preview;
let legendContainer;
// DOM elements for parent 1 genes
let parent1BlackAllele1;
let parent1BlackAllele2;
let parent1AgoutiAllele1;
let parent1AgoutiAllele2;
let parent1DilutionAllele1;
let parent1DilutionAllele2;
let parent1SpottingAllele1;
let parent1SpottingAllele2;
let parent1LengthAllele1;
let parent1LengthAllele2;
// DOM elements for parent 2 genes
let parent2BlackAllele1;
let parent2BlackAllele2;
let parent2AgoutiAllele1;
let parent2AgoutiAllele2;
let parent2DilutionAllele1;
let parent2DilutionAllele2;
let parent2SpottingAllele1;
let parent2SpottingAllele2;
let parent2LengthAllele1;
let parent2LengthAllele2;
...
function initializeDOM() {
    ...
    // Containers
    punnettContainer = document.getElementById('punnett-container');
    offspringStatsContainer = document.getElementById('offspring-stats-container');
    savedSettingsList = document.getElementById('saved-settings-list');
    parent1Preview = document.getElementById('parent1-preview');
    parent2Preview = document.getElementById('parent2-preview');
    legendContainer = document.getElementById('genetics-legend');
    // Parent 1 gene selects
    parent1BlackAllele1 = document.getElementById('parent1-black-allele1');
    parent1BlackAllele2 = document.getElementById('parent1-black-allele2');
    parent1AgoutiAllele1 = document.getElementById('parent1-agouti-allele1');
    parent1AgoutiAllele2 = document.getElementById('parent1-agouti-allele2');
    parent1DilutionAllele1 = document.getElementById('parent1-dilution-allele1');
    parent1DilutionAllele2 = document.getElementById('parent1-dilution-allele2');
    parent1SpottingAllele1 = document.getElementById('parent1-spotting-allele1');
    parent1SpottingAllele2 = document.getElementById('parent1-spotting-allele2');
    parent1LengthAllele1 = document.getElementById('parent1-length-allele1');
    parent1LengthAllele2 = document.getElementById('parent1-length-allele2');
    // Parent 2 gene selects
    parent2BlackAllele1 = document.getElementById('parent2-black-allele1');
    parent2BlackAllele2 = document.getElementById('parent2-black-allele2');
    parent2AgoutiAllele1 = document.getElementById('parent2-agouti-allele1');
    parent2AgoutiAllele2 = document.getElementById('parent2-agouti-allele2');
    parent2DilutionAllele1 = document.getElementById('parent2-dilution-allele1');
    parent2DilutionAllele2 = document.getElementById('parent2-dilution-allele2');
    parent2SpottingAllele1 = document.getElementById('parent2-spotting-allele1');
    parent2SpottingAllele2 = document.getElementById('parent2-spotting-allele2');
    parent2LengthAllele1 = document.getElementById('parent2-length-allele1');
    parent2LengthAllele2 = document.getElementById('parent2-length-allele2');
...
function colorizeAlleleSelect(selectElement, alleleType) {
...
function getAlleleColor(alleleType, allele) {
    switch (alleleType) {
        case 'blackSeries':
...
function updateParent1Genotype() {
    appState.parent1 = createGenotype(parent1BlackAllele1.value, parent1BlackAllele2.value, parent1AgoutiAllele1.value, parent1AgoutiAllele2.value, parent1DilutionAllele1.value, parent1DilutionAllele2.value, parent1SpottingAllele1.value, parent1SpottingAllele2.value, parent1LengthAllele1.value, parent1LengthAllele2.value);
    saveStateToStorage();
}
// Update parent 2 genotype from UI
function updateParent2Genotype() {
    appState.parent2 = createGenotype(parent2BlackAllele1.value, parent2BlackAllele2.value, parent2AgoutiAllele1.value, parent2AgoutiAllele2.value, parent2DilutionAllele1.value, parent2DilutionAllele2.value, parent2SpottingAllele1.value, parent2SpottingAllele2.value, parent2LengthAllele1.value, parent2LengthAllele2.value);
    saveStateToStorage();
}
...
function renderPhenotypePreview(container, phenotype) {
...
function createGeneVisualization(name, gene, traitType) {
...
function renderPunnettSquare(squareData) {
    ...
    parent1Gametes.forEach((gamete1, rowIndex) => {
        ...
        row.appendChild(th);
        // Add offspring cells
        parent2Gametes.forEach((gamete2, colIndex) => {
...
function renderOffspringStats(result) {
    const { phenotypeStats, totalCount } = result;
    // Clear the container
    offspringStatsContainer.innerHTML = '';
    const entries = Array.from(phenotypeStats.entries());
...
function saveCurrentSettings() {
    ...
    const newSetting = {
        id: generateId(),
        name,
        parent1: Object.assign({}, appState.parent1),
        parent2: Object.assign({}, appState.parent2),
...
function loadSetting(id) {
    ...
    if (setting) {
        appState.parent1 = Object.assign({}, setting.parent1);
        appState.parent2 = Object.assign({}, setting.parent2);
        updateUI();
        saveStateToStorage();
    }
}
